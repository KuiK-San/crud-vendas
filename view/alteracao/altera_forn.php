...
<body>
    ...
    <fieldset class="formulario" class="campo" >
        ...
        <form action="../../controller/altera/altera_forn.php?id=<?= $row['id_forn'] ?>" method="post">
            ...
            <a href="../../view/lists/lista_fornecedor.php"><input type="button" class="botao" value="Voltar"></a>
        </form>
    </fieldset>
